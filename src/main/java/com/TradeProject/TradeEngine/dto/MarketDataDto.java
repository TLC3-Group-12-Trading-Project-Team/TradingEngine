...
public class MarketDataDto {
    ...
    public MarketDataDto(final double lastTradedPrice, final double bidPrice, final int sellLimit, final double maxPriceShift, final String ticker,
    ...
    public String toString() {
        return "MarketDataDto {askPrice=" + askPrice + ", bidPrice=" + bidPrice + ", buyLimit=" + buyLimit
